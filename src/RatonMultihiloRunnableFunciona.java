...
public class RatonMultihiloRunnableFunciona implements Runnable {

    private String nombre;
    private long tiempoAlimentacion;

    public RatonMultihiloRunnableFunciona (String nombre, int tiempoAlimentacion){
        this.nombre = nombre;
    ...
    public static void main (String[] args) throws InterruptedException {
        ...
        ArrayList<Enum> Estados = new ArrayList<Enum>(); //Array de estados, variable Enum
        Estados.add(NEW);
        ...
        while (hilo_perez.isAlive()|| (hilo_jerry.isAlive()) || hilo_perez.isAlive()) {
            ...
            if (estadoActual != estadoAnterior) {
                System.out.println("Pérez = " + estadoActual);
