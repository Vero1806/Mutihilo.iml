...
public class ArrayEj3 implements Runnable{
    ...
    private ArrayList<Integer> numerosSuma;
    private volatile static int tamñoArray;

    public ArrayEj3(ArrayList<Integer> numerosSuma){
...
//        }
    ...
    public static void secuencial(ArrayList<Integer> numerosSuma) {
    ...
    public static void arrayMultihilo(ArrayList<Integer> numerosSuma) {
        ...
        ArrayList<Integer> mitad2 = new ArrayList<>(numerosSuma.subList(mitad + 1, numerosSuma.size())); // subList excluye el primero y incluye el segundo
        ...
        //ArrayListThread hilo_mitad1 = new ArrayListThread(mitad1);
